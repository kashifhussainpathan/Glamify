...
const ProductLoader = () => {
  return (
    <div className="w-[210px] p-2 shadow-small rounded-md cursor-pointer my-1 max-md:w-[150px] ">
      <Skeleton classes="md:h-[250px] w-full max-md:w-[130px] max-md:mx-auto max-md:h-[150px]" />
      ...
      <div className=" px-2 mt-1 max-md:px-[2px]">
        <div className="flex items-center gap-1 mt-2">
          <Skeleton classes="h-4 w-4 max-md:h-2 max-md:w-2" />
          <Skeleton classes="h-4 w-4 max-md:h-2 max-md:w-2" />
          <Skeleton classes="h-4 w-4 max-md:h-2 max-md:w-2" />
          <Skeleton classes="h-4 w-4 max-md:h-2 max-md:w-2" />

          <Skeleton classes="h-4 w-8 max-md:h-2 max-md:w-4" />
        </div>
